                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                                    <img src="{{ asset('public/img/group-people-volunteering-foodbank-poor-people.jpg') }}"
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-5 col-12">
                                    <img src="{{ asset('public/img/portrait-volunteer-who-organized-donations-charity.jpg') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                                    <div class="custom-block-wrap">
                                        <img src="{{ asset('public/img/causes/group-african-kids-paying-attention-class.jpg') }}"
                                ...
                                <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                                    <div class="custom-block-wrap">
                                        <img src="{{ asset('public/img/causes/poor-child-landfill-looks-forward-with-hope.jpg') }}"
                                            class="custom-block-image img-fluid" alt="">
                                ...
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="custom-block-wrap">
                                        <img src="{{ asset('public/img/causes/african-woman-pouring-water-recipient-outdoors.jpg') }}"
                                            class="custom-block-image img-fluid" alt="">
                    ...
                    <section class="volunteer-section section-padding" id="section_4">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <img src="{{ asset('public/img/smiling-casual-woman-dressed-volunteer-t-shirt-with-badge.jpg') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-12">
                                    <div class="news-block">
                                        <div class="news-block-top">
                                            <a href="news-detail.html">
                                                <img src="{{ asset('public/img/news/medium-shot-volunteers-with-clothing-donations.jpg') }}"
                                    ...
                                    <div class="news-block mt-3">
                                        <div class="news-block-top">
                                            <a href="news-detail.html">
                                                <img src="{{ asset('public/img/news/medium-shot-people-collecting-foodstuff.jpg') }}"
                                                    class="news-image img-fluid" alt="">
                                            </a>
                                ...
                                <div class="col-lg-4 col-12 mx-auto">
                                    ...
                                    <div class="news-block news-block-two-col d-flex mt-4">
                                        <div class="news-block-two-col-image-wrap">
                                            <a href="news-detail.html">
                                                <img src="{{ asset('public/img/news/africa-humanitarian-aid-doctor.jpg') }}"
                                                    class="news-image img-fluid" alt="">
                                            </a>
                                        </div>
                                    ...
                                    <div class="news-block news-block-two-col d-flex mt-4">
                                        <div class="news-block-two-col-image-wrap">
                                            <a href="news-detail.html">
                                                <img src="{{ asset('public/img/news/close-up-happy-people-working-together.jpg') }}"
                                                    class="news-image img-fluid" alt="">
                                            </a>
                                        </div>
